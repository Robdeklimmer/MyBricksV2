        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RebrickableSetNum = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RebrickablePartNum = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Name = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyGroups_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AveragePriceEur = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceCaches_Parts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SetParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SetParts_LegoSets_LegoSetId",
                        column: x => x.LegoSetId,
                        principalTable: "LegoSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SetParts_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFamilyGroups", x => new { x.UserId, x.FamilyGroupId });
                    table.ForeignKey(
                        name: "FK_UserFamilyGroups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFamilyGroups_FamilyGroups_FamilyGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserSets_FamilyGroups_FamilyGroupId",
                        column: x => x.FamilyGroupId,
                        principalTable: "FamilyGroups",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MissingParts_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MissingParts_UserSets_UserSetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyGroups_OwnerUserId",
                table: "FamilyGroups",
                column: "OwnerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LegoSets_RebrickableSetNum",
                table: "LegoSets",
                column: "RebrickableSetNum",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MissingParts_PartId",
                table: "MissingParts",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_MissingParts_UserSetId",
                table: "MissingParts",
                column: "UserSetId");

            migrationBuilder.CreateIndex(
                name: "IX_Parts_RebrickablePartNum",
                table: "Parts",
                column: "RebrickablePartNum");

            migrationBuilder.CreateIndex(
                name: "IX_PriceCaches_PartId",
                table: "PriceCaches",
                column: "PartId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SetParts_LegoSetId",
                table: "SetParts",
                column: "LegoSetId");

            migrationBuilder.CreateIndex(
                name: "IX_SetParts_PartId",
                table: "SetParts",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFamilyGroups_FamilyGroupId",
                table: "UserFamilyGroups",
                column: "FamilyGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSets_FamilyGroupId",
                table: "UserSets",
                column: "FamilyGroupId");
